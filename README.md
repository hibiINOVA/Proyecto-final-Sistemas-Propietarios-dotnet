...
(Nota: Los comandos dotnet add package... listados son para el desarrollo inicial; dotnet restore es el comando que el usuario final debe ejecutar. Los archivos G-code deben generados en slicer como cura o plusaslicer.)
